...
const ButtonCloseSideBarInLeftColumn = () => {
  return (
    <CloseSideBarIcon className="close-menu-icon Button-Close-SideBar-In-Left-Column" onClick={handleClick} bgColor={ColorBgMobileSidebar} classToggleSideBar={ClassToggleSideBar} bpDesktop={BpDesktop}/>
  );
}
